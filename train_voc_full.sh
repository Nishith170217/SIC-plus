...
if [ -f "/home/woody/rlvl/rlvl171v/SIC/results/voc_full/checkpoint.pth" ]; then
    RESUME_ARG=(--resume)
fi

python train_sic_voc.py \
    --data_dir=/home/woody/rlvl/rlvl171v/data/pascal-voc/VOCdevkit/VOC2007 \
    --results_dir=/home/woody/rlvl/rlvl171v/SIC/results/voc_full \
    --epochs=50 \
    --batch_size=8 \
    --n_shot=3 \
