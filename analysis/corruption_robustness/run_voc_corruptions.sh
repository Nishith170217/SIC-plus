#!/bin/bash
#SBATCH --job-name=voc_corruptions
...
python analysis/corruption_robustness/evaluate_voc_corruptions.py \
    ...
    --output_dir=/home/woody/rlvl/rlvl171v/SIC/experiments/corruption_robustness/voc \
    --batch_size=32 \
